...
Active Service: TypeScript — **active initiative (2026-07-11): marketing site + platform convergence.** Platform escalation UI merged to `main-dev` (PR #14). Marketing on `feat/marketing-site-scaffold`: homepage, 4 priority programmes, pricing (four-label), contact/leads. **Next:** abnormal screening E2E test, `/medication` + `/labs`, merge marketing PR, staging deploy. See `docs/MARKETING_SITE_SPEC.md` §7.
