...
- DB/Auth/Storage/Realtime: Supabase Postgres, **`eu-west-1`** region for now (`af-south-1` for NDPR data residency was not selectable at creation — revisit/migrate when available), pgvector
