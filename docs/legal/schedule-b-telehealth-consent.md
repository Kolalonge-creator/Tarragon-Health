...
*Draft for legal review — not yet approved by counsel. Version 2026-07-31-v3 (full rewrite — the prior version described a narrower, cardiometabolic-only product superseded within a day of being specified; see the cover memo's "What changed" section). This text is the canonical source for the `telehealth` consent content and for any future public/patient-facing rendering of it; edit here first, then re-sync wherever it's reused.*

## About this document
This is TarragonHealth's Telehealth Consent — Schedule B of our legal documentation. Version 2026-07-31-v3, published 31 July 2026. This document is currently in draft and pending final review by our legal counsel.
