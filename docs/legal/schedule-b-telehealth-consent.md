...
*Draft for legal review — not yet approved by counsel. Version 2026-08-12-v1 (the "How we communicate with you" WhatsApp bullet corrected: it previously promised two-way WhatsApp messaging with a doctor, which was retired 2026-07-30 in favour of in-app-only care-team conversation — see the 2026-08-12 marketing-site audit and migration `20260812002832_telehealth_consent_in_app_messaging_not_whatsapp.sql`). This text is the canonical source for the `telehealth` consent content and for any future public/patient-facing rendering of it; edit here first, then re-sync wherever it's reused.*

## About this document
This is TarragonHealth's Telehealth Consent, Schedule B of our legal documentation. Version 2026-08-12-v1, published 12 August 2026. This document is currently in draft and pending final review by our legal counsel.
