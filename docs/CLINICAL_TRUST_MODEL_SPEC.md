...
- **NDPR data residency** already covers `clinical_staff` credential data — no separate infrastructure needed, just make sure it lives in the same eu-west-1 Supabase project as everything else.
