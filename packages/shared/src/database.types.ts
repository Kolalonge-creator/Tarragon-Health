...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      diabetic_foot_assessments: {
        ...
        Insert: {
          ...
          sensation_left?: Database["public"]["Enums"]["foot_sensation"] | null;
          sensation_right?:
            Database["public"]["Enums"]["foot_sensation"] | null;
          updated_at?: string;
        };
        Update: {
          assessed_at?: string;
      ...
      lab_orders: {
        Row: {
          ...
          patient_id: string;
          payment_provider:
            Database["public"]["Enums"]["payment_provider"] | null;
      ...
      obesity_assessments: {
        Row: {
          ...
          clinical_status:
            Database["public"]["Enums"]["obesity_clinical_status"] | null;
          complications: Json;
          created_at: string;
      ...
      screen_types: {
        Row: {
          ...
          recommended_provider_type:
            Database["public"]["Enums"]["organisation_type"] | null;
          sensitive: boolean;
      ...
      vitals_readings: {
        Row: {
          ...
          glucose_context:
            Database["public"]["Enums"]["glucose_context"] | null;
      ...
      wallet_ledger: {
        Row: {
          ...
          booking_order_id: string | null;
          booking_order_type: Database["public"]["Enums"]["commission_type"] | null;
          created_at: string;
    ...
    Functions: {
      ...
      get_or_create_my_referral_code: { Args: Record<string, never>; Returns: string };
      get_or_create_wallet_for: { Args: { p_profile: string }; Returns: string };
      get_or_create_my_wallet: { Args: Record<string, never>; Returns: string };
      ...
      wallet_pay_booking_order: {
        Args: { p_order_type: string; p_order_id: string };
        Returns: Json;
      };
    ...
    Enums: {
      ...
      commission_type:
        "lab" | "pharmacy" | "referral" | "home_visit" | "delivery";
      ...
      glucose_context:
        "fasting" | "random" | "post_meal" | "pre_meal" | "bedtime" | "night";
      ...
      insulin_type:
        "soluble" | "nph" | "premixed" | "analogue_rapid" | "analogue_long";
      ...
      vaccination_verification_status:
        "self_reported" | "pending_verification" | "verified" | "rejected";
      video_consultation_context:
        "pre_referral_triage" | "specialist_consult" | "annual_review";
      ...
      wearable_provider:
        "apple_health" | "oura" | "whoop" | "garmin" | "fitbit";
    };
    CompositeTypes: {
      [_ in never]: never;
    };
