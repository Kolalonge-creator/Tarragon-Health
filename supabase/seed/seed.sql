...
values
  ('essential_usd', 'Essential Care', 'One condition: monthly doctor review, monthly doctor check-in, WhatsApp care team access.',
     3400, 'USD', 'monthly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills'], false),
  ...
  ('essential_yearly_usd', 'Essential Care (yearly)', 'Essential Care billed annually — 2 months free.',
     34000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills'], false),
  ...
  ('complete_usd', 'Complete Care', 'Multiple conditions or higher risk: weekly doctor review, priority doctor escalation.',
     7900, 'USD', 'monthly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation'], false),
  ...
  ('complete_yearly_usd', 'Complete Care (yearly)', 'Complete Care billed annually — 2 months free.',
     79000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation'], false),
  ...
  ('family_lite_gbp', 'Family Lite', 'Up to 4 people back home on one plan: monitoring matched to each member, shared family dashboard, one combined bill, monthly family report. Billed yearly in GBP.',
     59000, 'GBP', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ('family_plus_gbp', 'Family Plus', 'Everything in Family Lite, plus a named family doctor coordinator, priority escalation across all members, and one free Annual Health Check a year. Billed yearly in GBP.',
     89000, 'GBP', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ('family_premium_gbp', 'Family Premium', 'Everything in Family Plus, plus a named doctor coordinator with a scheduled monthly appointment for every member, quarterly reports, expedited response, and two free Annual Health Checks a year. Billed yearly in GBP.',
     139000, 'GBP', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'quarterly_report', 'expedited_response', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ('family_lite_usd', 'Family Lite', 'Up to 4 people back home on one plan: monitoring matched to each member, shared family dashboard, one combined bill, monthly family report. Billed yearly in USD.',
     79000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ('family_plus_usd', 'Family Plus', 'Everything in Family Lite, plus a named family doctor coordinator, priority escalation across all members, and one free Annual Health Check a year. Billed yearly in USD.',
     119000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ('family_premium_usd', 'Family Premium', 'Everything in Family Plus, plus a named doctor coordinator with a scheduled monthly appointment for every member, quarterly reports, expedited response, and two free Annual Health Checks a year. Billed yearly in USD.',
     189000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'quarterly_report', 'expedited_response', 'annual_review', 'lifestyle_coaching', 'health_education'], false),
  ...
  ('parentcare_usd', 'ParentCare', 'Dedicated monitoring for up to 2 parents from abroad: named doctor coordinator, scheduled doctor review, quarterly family report, priority escalation, and lab/pharmacy coordination in Nigeria.',
     15900, 'USD', 'monthly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'quarterly_report'], false),
  ('parentcare_yearly_usd', 'ParentCare (yearly)', 'ParentCare billed annually — 2 months free.',
     159000, 'USD', 'yearly', array['chronic', 'clinician_review', 'doctor_checkin', 'lab_coordination', 'medication_refills', 'priority_escalation', 'family_dashboard', 'dedicated_coordinator', 'quarterly_report'], false)
on conflict (code) do nothing;
...
values
  ...
  ('extra-family-member_usd', 'Extra Family Member',
     ...
     16000, 'USD', 'yearly', array['extra_family_slot'], 'family_lite_usd', false),
  ('extra-family-member_gbp', 'Extra Family Member',
     'Adds one more person to Family Lite (up to 6 total) at the same level of monitoring.',
     12000, 'GBP', 'yearly', array['extra_family_slot'], 'family_lite_gbp', false),
  ('extra-family-member-plus_gbp', 'Extra Family Member (Family Plus)',
     'Adds one more person to Family Plus (up to 6 total) at the same level of monitoring.',
     16000, 'GBP', 'yearly', array['extra_family_slot'], 'family_plus_gbp', false),
  ('extra-family-member-premium_gbp', 'Extra Family Member (Family Premium)',
     'Adds one more person to Family Premium (up to 6 total) at the same level of monitoring.',
     25000, 'GBP', 'yearly', array['extra_family_slot'], 'family_premium_gbp', false),
  ('extra-family-member-plus_usd', 'Extra Family Member (Family Plus)',
     'Adds one more person to Family Plus (up to 6 total) at the same level of monitoring.',
     21000, 'USD', 'yearly', array['extra_family_slot'], 'family_plus_usd', false),
  ('extra-family-member-premium_usd', 'Extra Family Member (Family Premium)',
     'Adds one more person to Family Premium (up to 6 total) at the same level of monitoring.',
     34000, 'USD', 'yearly', array['extra_family_slot'], 'family_premium_usd', false),
