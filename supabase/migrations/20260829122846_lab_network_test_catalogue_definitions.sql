...
from (values
  ...
  ('chlamydia_gonorrhoea',  'First-catch urine, or a self-collected swab', 'No need to fast. If you are giving a urine sample, try not to pass urine for at least an hour beforehand.', null, 'Not detected / Detected', 'A routine sexual-health screen for chlamydia and gonorrhoea. Both are common, both often cause no symptoms at all, and both are treated with a short course of antibiotics once found.'),
