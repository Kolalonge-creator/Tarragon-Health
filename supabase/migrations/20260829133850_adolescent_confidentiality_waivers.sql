...
-- confidentiality waivers (follow-up to 20260829121248).
--
...
-- three policies, updated below in the same migration.
drop function if exists private.guardian_may_view_confidential_domain(uuid);
