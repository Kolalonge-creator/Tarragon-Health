...
-- immediately-following migration, which found the real cause (anon inherits
-- via the PUBLIC pseudo-grant, not a direct grant) and fixed it for real.
-- Kept as a harmless no-op for an honest migration history rather than
-- deleted/rewritten.
