-- Tarragon Health
-- Extends public.public_partner_locations() (20260825201426) with the new
-- pharmacy_partner_locations table, same shape as the lab branch UNION arm
-- added in that migration.
