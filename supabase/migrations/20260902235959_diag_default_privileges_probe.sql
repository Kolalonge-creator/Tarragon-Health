...
-- of guessed at. See docs/CLAUDE_SPRINT_HISTORY_ARCHIVE.md-adjacent memory
-- for the standing "ALTER DEFAULT PRIVILEGES does not reliably work on this
-- project" finding for the `private` schema -- this either confirms the
-- same mechanism applies to `public`, or finds a new one.
do $$
declare
