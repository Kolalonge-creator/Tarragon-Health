...
const TEAM: TeamMember[] = [
  ...
  },
  {
    kind: "person",
    id: "maxwell-dayok",
    name: "Dr Dayok P. Maxwell",
    title: "Chief Medical Officer",
    credentials: "MBBS · MPH · FMCFM · FRCEM",
    photoSrc: "/marketing/cmo-maxwell-dayok.jpg",
    photoAlt: "Dr Dayok P. Maxwell, Chief Medical Officer at TarragonHealth",
    bio: "Dr Dayok P. Maxwell is Chief Medical Officer at TarragonHealth, with over 20 years of clinical practice spanning Nigeria and the United Kingdom in Emergency Medicine, Family Medicine, and Public Health. He qualified with an MBBS from the University of Jos, Nigeria, and holds an MPH from Ahmadu Bello University. He is a Fellow of the Royal College of Emergency Medicine (FRCEM) and a Fellow of the West African College of Physicians in Family Medicine (FMCFM), and practises as a Consultant in Family Medicine. He also holds a Postgraduate Certificate in Medical and Healthcare Education from Anglia Ruskin University. Dr Maxwell built his early career within Nigeria's healthcare system before relocating to the UK, giving him first-hand experience of both systems and the populations they serve. That range, acute care, primary care, and prevention, across two very different health economies, shapes his approach at TarragonHealth. As CMO, he provides clinical leadership and oversight across the organisation, working with the leadership and product teams to ensure TarragonHealth's products and strategies are safe, evidence-based, and centred on the patient. His focus: prevention, early detection, and continuity of care.",
    quote:
