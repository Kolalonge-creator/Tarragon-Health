...
const TRUST_ITEMS = [
  {
    ...
    body: "Every review is made by a doctor and carries their real name on the note itself, never an anonymous system, and never named before they've actually reviewed it.",
    icon: (
