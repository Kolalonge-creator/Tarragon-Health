    ...
    health === "none"
      ? from === "abroad"
        ? {
            ...
            secondary:
              "Just want to self-track for now? Tarragon Free is ₦0 forever, and the Annual Health Check (from ₦15,000, in Nigeria) is available to anyone, on any plan.",
          }
        : {
            ...
            why: "The stay-healthy plan: a screening and vaccination calendar built around them, bookable when checks come due, plus personalised health education, so small things get caught before they become conditions.",
            secondary:
              "Just want to self-track for now? Tarragon Free is ₦0 forever, and the Annual Health Check (from ₦15,000) is available to anyone, on any plan.",
          }
      : health === "one"
        ? from === "abroad"
          ? {
