...
export const DEVICES_FAQ: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "No. Tarragon doesn't sell, ship, or earn a commission on any of these devices. Buy from whichever retailer you trust; we recommend them purely for clinical accuracy and confirmed compatibility.",
  },
] as const;
