...
export const PREVENTION_CALLOUT = {
  ...
  body:
    "You don't need a diagnosis to belong here: a personal screening and vaccination calendar, plus a yearly Health Check paid for once when you take it. If something's found, a doctor follows up within a day, sooner if it's critical.",
} as const;
...
export const HOMEPAGE_FAQS = [
  ...
  },
  {
    ...
    answer:
      "Yes: prevention is half of what Tarragon does. A personal screening and vaccination calendar, a yearly health check, and matched education keep healthy people healthy. The app is free; the yearly check is a one-off you pay for when you take it. Most years, that's just confirmation all is well; if something's found, a doctor follows up within a day, sooner if it's critical.",
  },
  {
    category: "general",
