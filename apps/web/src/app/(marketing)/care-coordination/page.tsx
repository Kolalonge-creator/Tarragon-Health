...
const CONNECTS = [
  ...
  },
  {
    ...
    body: "Send a written question and get a doctor's reply within 72 hours via the app, included on Care Pass, or book a 15-minute online consultation with a doctor on any plan. Your payment is only taken once a doctor accepts your slot, and refunded in full if none can.",
  },
];
