      ...
      <CardContent className="space-y-5 text-sm text-charcoal-ink/80 dark:text-night-ink/80">
        {diabetesType === "type_1" && (
          <div className="rounded-md border border-amber-300 dark:border-amber-500/40 bg-amber-50/60 dark:bg-amber-500/10 p-3">
            <p className="font-medium text-amber-800 dark:text-amber-300">Type 1: keep taking your insulin</p>
            <p className="mt-1">
              Not eating, feeling unwell, fasting, or running low on supplies is not a reason to
        ...
        <section className="space-y-1.5">
          ...
          <ul className="list-disc space-y-0.5 pl-5">
            <li><strong>Do not stop your insulin</strong>, even if you&apos;re not eating. You often need it more when ill.</li>
        ...
        <section className="space-y-1.5">
          ...
          <ul className="list-disc space-y-0.5 pl-5">
            <li>Unopened insulin: keep in a fridge (2–8°C). Do not freeze it, and keep it out of direct sun and hot cars.</li>
