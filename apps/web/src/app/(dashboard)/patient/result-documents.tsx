...
import { loadResultDocuments, type ResultDocumentView } from "@/lib/lab-results/documents";
...
function groupByTestType(documents: ResultDocumentView[]): { label: string; documents: ResultDocumentView[] }[] {
  const order: string[] = [];
