  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <SectionCard title="Escalation & repeat contact" description="Technical-tier escalations and clinical flags, and repeat-contact rate.">
          <div className="grid grid-cols-2 gap-4 p-4">
            <StatTile icon={TrendingUp} label="Escalation rate" value={t?.escalation_rate_pct != null ? formatPercent(t.escalation_rate_pct) : "—"} unit="clinical or technical tier" />
