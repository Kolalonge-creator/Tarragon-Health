    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-charcoal-ink/60">
          ...
          actual renewed prescription through the patient&apos;s notes, as usual.
        </p>
      </div>
      <Card>
        <CardHeader>
        ...
        <CardContent>
          ...
          {data && (
            <SearchableList
              ...
              // SearchableList's own default pageSize (25) would newly hide
              // any request past the 25th behind a "Next" click — before this
              // diff every pending request (including any already past its
              // SLA) rendered on one screen with no pagination at all, and an
              // overdue renewal one page away is exactly the kind of thing
              // this worklist must not let a clinician miss. This mirrors the
              // size of every other unbounded worklist read on this page's
              // sibling pages (e.g. results-inbox's 200-row fetch cap).
              pageSize={200}
