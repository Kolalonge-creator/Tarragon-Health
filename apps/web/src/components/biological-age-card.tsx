 ...
 *
 * The ring recolors by risk level like any meter (dataviz: "the fill carries severity,
 * the unfilled track is a lighter step of the same ramp"), while staying the separate
 * clinical-status color system from brand color per CLAUDE.md — the badge already
 * draws from that system; this just extends it to the ring/age-gap chip.
 */
